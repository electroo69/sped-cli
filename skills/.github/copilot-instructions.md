...
This project uses `smol-cli` for shell operations. Use these 242 token-efficient aliases instead of full shell commands. Every alias is a standalone executable — no prefix needed.
